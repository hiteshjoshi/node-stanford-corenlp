...
var StanfordSimpleNLP = (function(userOptions) {
  ...
  function loadLibrary(path){
    ...
    java.classpath.push(path+"/stanford-corenlp-3.3.1-models.jar");
    java.classpath.push(path+"/stanford-corenlp-3.3.1.jar");
  };
